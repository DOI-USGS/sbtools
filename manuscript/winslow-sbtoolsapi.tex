...
omitted from code below for simplicity. See \code{demo('figure_map_code', package='sbtools')} 
for full example.
...
through an OGC WFS web service. Note: Some formatting details of code
omitted from code below for simplicity. See \code{demo('figure_fault_code', package='sbtools')} 
for full example.
