...
stored. One example is spatial data. When spatial data uploaded to ScienceBase 
...
Feature Service (WFS) when available.
...
tree. For example, projects funded by USGS Climate Science Centers have sections on ScienceBase
where project information is stored. Below is an example of looking for 
lake related items under the Northeast Climate Science Center community. 
...
> query_sb_datatype('US Topo', limit=2)
[[1]]
<ScienceBase Item>
