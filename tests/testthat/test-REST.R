...
test_that("generic post fails w/o auth", {
	...
	# auth fails locally:
	expect_error(item_append_files("54e265a4e4b08de9379b4dfb", '/foo/bar/baz.zip'),'no authenticate info')
	...
	expect_error(item_append_files("54e265a4e4b08de9379b4dfb", files, session), 'This file does not exist')
