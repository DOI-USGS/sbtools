...
#' 
#' Search for text in the title, abstract, etc. within an SB folder
#' 
...
query_item_in_folder <- function(text, folder, ..., session=current_session(), limit=20) {
	url=paste0("https://www.sciencebase.gov/catalog/items?q=",text,"&max=",limit,"&folderId=",folder,"&format=json")
	query=list('max'=limit, 'format'='json')
